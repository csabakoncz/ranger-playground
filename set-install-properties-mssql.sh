sed -ie "s/^db_root_password=.*$/db_root_password=1234Password/" ranger/security-admin/scripts/install.properties
...
echo "SQL_CONNECTOR_JAR=$MAVEN_REPO/com/microsoft/sqlserver/mssql-jdbc/8.2.2.jre8/mssql-jdbc-8.2.2.jre8.jar" >> ranger/security-admin/scripts/install.properties
